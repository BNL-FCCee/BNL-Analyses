...
outputDir   = "outputs_HInvee_CLIC/stage1"
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            .Define("electrons", "sel_byPDGID()(TightSelectedPandoraPFOs,11)")
            ...
            .Define("muons", "sel_byPDGID()(TightSelectedPandoraPFOs,13)")
            ...
            #.Define("MET", "100") #absolute value of MET


            # build a candidate Z boson
            .Define("ZCandidate",    "ReconstructedParticle::resonanceBuilder(91)(electrons)")
            # Z boson pt
            ...
            .Define("recoilParticle",  "ReconstructedParticle::recoilBuilder(380)(ZCandidate)")
